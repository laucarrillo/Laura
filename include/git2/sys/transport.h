 ...
 * @return the return value of the callback: 0 for no error, <0 for an
 *         error, or >0 if there is no callback registered or the callback
 *         chose not to behave as if there were no callback and did not
